...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------------------------------------------------------------------+
   * |     |     | Alt | Win | Ctrl|   SHIFT    | RET  | MOV |     |Mute |Vol- |
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT(
  ...
  KC_TAB , KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,    KC_N,    KC_M,    KC_DOT,  KC_QUOTE, KC_COLON,      KC_AUDIO_VOL_UP,
  _______, _______, KC_LALT, KC_LGUI,  KC_LCTRL,      MO(1),      KC_ENTER,TT(4),   _______,  KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN
),
...
LAYOUT(
  ...
  _______,  S(KC_A),    S(KC_S),    S(KC_D),    S(KC_F),    S(KC_G),    S(KC_H),   S(KC_J),    S(KC_K),    S(KC_L),         KC_TILDE,     _______,
  KC_CAPS,  S(KC_Z),    S(KC_X),    S(KC_C),    S(KC_V),    S(KC_B),    S(KC_N),   S(KC_M),    KC_COMMA,   KC_DOUBLE_QUOTE, KC_SCOLON,    _______,
