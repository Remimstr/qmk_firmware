...
LAYOUT(
  ...
  MO(2),   KC_A,    KC_S,    KC_D,     KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,     KC_SPC,   MO(2),
  _______, KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,    KC_N,    KC_M,    KC_DOT,  KC_COLON, KC_QUOTE, KC_AUDIO_VOL_UP,
  _______, _______, _______, KC_LCTRL, KC_LGUI,      MO(1),       KC_LALT, _______, _______,  _______,  KC_AUDIO_VOL_DOWN
),
...
LAYOUT(
  ...
  _______,  S(KC_Z),    S(KC_X),    S(KC_C),    S(KC_V),    S(KC_B),    S(KC_N),   S(KC_M),    KC_COMMA,      KC_SCOLON,   KC_DOUBLE_QUOTE,    _______,
...
LAYOUT(
  _______, KC_1,    KC_3,    KC_5,    KC_7,    KC_9,    _______, KC_TILDE, KC_PLUS,  KC_ASTERISK, KC_EQUAL,   _______,
...
LAYOUT(
  ...
  _______, KC_RIGHT_PAREN, KC_RIGHT_CURLY_BRACE, KC_RBRACKET, KC_RIGHT_ANGLE_BRACKET, _______, _______, KC_BSLASH, KC_QUESTION, KC_AMPERSAND, KC_PERCENT, _______,
  _______, _______,        _______,              _______,     _______,                _______, _______, _______,   _______,     _______,      _______,    _______,
  _______, _______,        _______,              _______,              _______,                _______, _______,   _______,     _______,      _______,    _______
)
};
