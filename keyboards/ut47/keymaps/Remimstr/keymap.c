...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------------------------------------------------------------------+
   * |     |     | Alt |Ctrl |SFT   |   SPC     | RET  | Gui |MV(4)|Mute |Vol- |
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT(
  ...
  LCTL(KC_A),           _______, KC_LALT, KC_LCTRL, MO(1),       KC_SPACE,        KC_ENTER, KC_LGUI, MO(4),    LT(5, KC_AUDIO_MUTE), KC_AUDIO_VOL_DOWN
),
...
LAYOUT(
  KC_0,     KC_1,    KC_2,    KC_3,    _______, _______, _______, KC_PLUS,   KC_ASTERISK, KC_CIRCUMFLEX,   _______,   _______,
  _______,  KC_4,    KC_5,    KC_6,    _______, _______, _______, KC_MINUS,  KC_PERCENT,  KC_EQUAL,        _______,   _______,
...
LAYOUT(
  _______, _______,  KC_LEFT_PAREN,  KC_LEFT_CURLY_BRACE,  KC_LBRACKET, KC_LEFT_ANGLE_BRACKET,  _______,   KC_AMPERSAND,  KC_EXCLAIM,  KC_TILDE,     KC_DOLLAR,      _______,
  _______, _______,  KC_RIGHT_PAREN, KC_RIGHT_CURLY_BRACE, KC_RBRACKET, KC_RIGHT_ANGLE_BRACKET, _______,   KC_UNDERSCORE, KC_QUESTION, KC_AT,        KC_HASH,        _______,
